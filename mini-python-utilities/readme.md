...
## Utilities
- 'calculator.py': A simple calculator performing addition,substraction,multiplication and division using function calling. 
 -'temp_celesius_farhenit.py':Conversion of Celsius to Fahrenheit and vice versa using if else,elif block,try -except handling and function calls. 
 -'number_guessing.py': A number guessing game built with loops and conditions.
 -'contact_book.py':Dictionary based contact manager
 '-ceil,floor,trunc.py-Demonstrates the difference between three math operations 'ceil','floor' and 'trunc'.
